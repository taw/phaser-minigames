...
(function() {
  var Character, GameState, Phaser, game, size_x, size_y;
  ...
  Character = (function() {
    function Character() {
      this.active = true;
      this.c = String.fromCodePoint(game.rnd.between(0x30A0, 0x30FF));
      this.x = game.rnd.between(0, size_x);
      this.y = game.rnd.between(0, size_y / 4);
      this.speed = game.rnd.between(30, 200);
